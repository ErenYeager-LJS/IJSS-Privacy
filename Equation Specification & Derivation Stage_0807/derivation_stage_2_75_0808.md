...
`PO-13` is moved before `PO-07`. It is a design-domain feasibility check on the bootstrap set, not a theorem consequence and not a premise of local existence. `PO-07` may begin after `PO-16A`, `PO-03`, `PO-02`, `PO-06`, `PO-08`, `PO-09`, `PO-10`, and `PO-13` have supplied their stated prerequisites.
...
PO-02 uses PO-01 and the local PO-03 estimate to establish the declared residual convolution condition. PO-10 uses PO-01 and PO-03 to close the privacy Lyapunov inequality. Neither requires global continuation or PO-07.
...
| PO-07 start condition | PASS | PO-07 may begin after PO-16A, PO-03, PO-02, PO-06, PO-08, PO-09, PO-10, and PO-13. |
...
4. PO IDs changed: `PO-03`, `PO-07`, `PO-08`, `PO-09`, `PO-10`, `PO-11`, `PO-12`, `PO-13`, and the former `PO-16` split into `PO-16A` and `PO-16B`.
5. PO-07 may now begin: **YES, structurally and conditionally**, after its revised prerequisites are closed; it is not yet proved.
