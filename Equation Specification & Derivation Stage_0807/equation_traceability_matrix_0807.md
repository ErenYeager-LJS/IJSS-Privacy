...
| ES-58--ES-61 | PRI | Alternative private-realization construction | `p_i',q_i',c_i',z_i',g_i',w_i'` | A2 supplies nominal split, weight-interior, and finite-seed schedule margins only; PO-04 now proves local alternative existence, identical public history, and a positive physical perturbation radius, while denominator continuation remains PO-05 | PO-04, PO-05, PO-15 | Lemma 1; Thm. 4 | Privacy proof construction | PO-04 proved locally; PO-05 open |
