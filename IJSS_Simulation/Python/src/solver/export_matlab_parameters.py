...
p=load_parameters(); plant=p['plant']; ctl=p['controller']; pr=p['privacy']; ppc=p['ppc']; d=p['domain']
...
'x0':initial_state(p),'rtol':p['solver']['rtol'],'atol':p['solver']['atol'],'maxstep':p['solver']['max_step'],'stoptime':0.9696157164357533}
