...
| PO-10 | Privacy Lyapunov chain | Close ES-87--ES-101 by applying PO-01 and the local command-rate estimate PO-03; give explicit positive `a_z,a_r` and finite `d_c`. | ES-43--ES-51, ES-87--ES-101 | Assumption 2; PO-01; PO-03; explicit private-weight/epsilon design region | Channel-combined privacy inequality, with conditions on `eps_r1,eps_r2` and private-weight margins. | PO-07; Theorem 1 | PARTIAL | The local algebra is closed, but the stated private-weight and epsilon feasibility inequalities are not yet part of a concrete admissible design region. It does not use ES-51. |
...
| PO-13 | Bootstrap actuator and funnel feasibility | Verify, before composite gain closure, that there exists a joint choice of funnel endpoints, deadlines, preliminary gains, residual allocation, and compact bootstrap set `K_0` satisfying ES-38, ES-67, ES-68, ES-95 and `u_i in U_i` for all states in `K_0`. This is a design-domain feasibility check, not a consequence of Theorem 1 or ES-102. | ES-12, ES-22--ES-31, ES-62, ES-67, ES-68, ES-95 | Assumption 1; Assumption 2; PO-02A; PO-03; PO-16A | Explicit symbolic feasibility test and strict actuator/gain/deadline margin inequalities; no use of ES-51, ES-102, or PO-07. | PO-07; PO-11; PO-16B; Theorems 1--2 | PARTIAL | Symbolic conditions are derived, but no concrete actuator/gain/deadline tuple or equivalent nonempty-margin certificate is declared in the frozen documents. Blueprint reopen only if no retained-controller design can satisfy the conditions. |
...
| PO-16A | Local closed-loop well-posedness and bootstrap-domain existence | Establish local existence and uniqueness of the ES-1--ES-82 vector field on the admissible open domain `D_open`, and select a compact bootstrap set `K_0` with the initial state in its interior. No forward invariance, actuator feasibility, or global boundedness is claimed here. | ES-1--ES-16, ES-22--ES-23, ES-41--ES-53, ES-80--ES-82 | Assumption 1 regularity and initial funnel feasibility; Assumption 2 bounded admissible privacy parameters | Local Lipschitz/continuation-to-exit statement, maximal local interval, and a compact `K_0` embedded in `D_open`. | PO-03; PO-08; PO-09; PO-13; PO-11; PO-16B | PROVED | Local existence/uniqueness and compact bootstrap construction are proved; no forward invariance, actuator feasibility, or global boundedness is claimed. |
...
| PO-10 | PARTIAL | 2026-08-08 (local algebra) | `derivation_stage_3_bootstrap_0808.md`, PO-10 | YES |
| PO-11 | OPEN | -- | Not yet derived | NO |
| PO-12 | OPEN | -- | Not yet derived | NO |
| PO-13 | PARTIAL | 2026-08-08 (symbolic feasibility conditions) | `derivation_stage_3_bootstrap_0808.md`, PO-13 | YES |
...
The Stage-2.5 repair has been incorporated into the authoritative ledger. Its former aggregate `PO-16` dependency is split here into local well-posedness `PO-16A` and forward continuation `PO-16B`. The former aggregate `PO-02` is split into local finite residual boundedness `PO-02A` and the later decaying envelope `PO-02B`. `PO-08` and `PO-09` are now proved only as pointwise local inequalities on `K_0`; `PO-10` remains partial until its private-weight/epsilon design region is declared. PO-13 is partial until strict actuator/gain/deadline margins are certified. The Equation Freeze gate remains conditional.
