...
| ES-43 | PRI | Bounded correction factor | `g_i,z_i,gamma_priv,i` | A2 positive decay schedule; Version 2.2 uniform positive schedule margin on the common finite privacy seed interval | PO-01, PO-04, PO-05, PO-10 | Lemma 1 | Privacy wrapper | Frozen candidate |
...
| ES-54--ES-57 | PRI | Protected datum and observation-equivalence target | `S_i,S_i',O_adv,q_i,w_i,A_i` | A2 passive adversary; local claim restricted to the Version 2.2 schedule-regular privacy domain before the finite-seed/first-exit stopping boundary | PO-04, PO-15 | Def. 2; Thm. 4 | Privacy definition | Frozen candidate |
| ES-58--ES-61 | PRI | Alternative private-realization construction | `p_i',q_i',c_i',z_i',g_i',w_i'` | A2 supplies nominal split, weight-interior, and finite-seed schedule margins only; PO-04 proves local alternative existence, identical public history, positive physical perturbation radius, and denominator legality on the initial/common construction interval; PO-05 covers any additional denominator validity, continuation, or compatible extension beyond that interval to the retained stopping boundary | PO-04, PO-05, PO-15 | Lemma 1; Thm. 4 | Privacy proof construction | PO-04 and PO-05 proved locally; no global continuation |
...
| ES-90--ES-91 | LYA/PPC | Transformation-gain upper bound | `h_i,h_bar_i,rho_i,sigma_i` | A1; JECFC compact sublevel set with `|sigma_i|<1` margin | Joint Exit-Continuation Lemma | Thm. 1; Thm. 2 | PPC proof estimates | Conditional proof object |
...
| ES-102 | LYA | Composite comparison inequality from the assembled local quadratic certificate | `mathscr V_cl,W_D,Q_cl,a_cl,d_R,d_priv` | A1--A2; PO-02A, PO-03, PO-06, PO-08--PO-10, PO-13; `Q_cl` positive definite, with `(h_bar_i^omega)^2` in `W_D^omega` | PO-07 | Thm. 1; Thm. 2 | Main stability comparison | Proof-derived local inequality |
